...
public:
	...
	void tileCollision(Creature& entity, const Tile& tile, const CollisionSideType side) noexcept override;
	void entityCollision(Creature& entity, const Entity& collider, const CollisionSideType side) noexcept override;
