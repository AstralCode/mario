...
void InitialGameState::onEnter()
{
	...
	const std::vector<std::vector<unsigned int>> tileIdentifiers =
	{
		...
		{  41,  43,  43,  42,  44, 000, 000, 000,  70, 000, 000,  38,  39,  39,  39,  40, 000,  70, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000 },
	...
	mGameObjectFactory.createMario()->setPosition(tilemap.getTileCenterPosition({3, 10}));
	
	mGameObjectFactory.createGoomba()->setPosition(tilemap.getTileCenterPosition({11, 10}));
	mGameObjectFactory.createGoomba()->setPosition(tilemap.getTileCenterPosition({13, 10}));
